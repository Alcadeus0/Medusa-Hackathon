  ...
  return (
    <Transition.Root show={open} as={Fragment}>
      ...
      >
        ...
        >
          <div className="relative max-w-md w-full bg-[pink] shadow-xl pb-12 flex flex-col overflow-y-auto">
            ...
            {Object.keys(filterables).map(key => {
              ...
              const options = values.map(value => {
                ...
                return (
                  <label
                    key={value}
                    className="block px-4 py-2 text-sm leading-5 text-black"
                  >
                    <input
                      type="checkbox"
              ...
              return (
                <div key={key} className="px-4 py-2">
                  <h3 className="text-sm leading-5 font-medium text-black">
                    {filterable.title}
                  </h3>
