...
const IndexPage = ({ data }) => {
  ...
  return (
    <div>
      ...
      <div className="pb-12 w-full px-4 sm:px-6 lg:px-12 band">
        <div className="flex flex-col justify-center items-center">
            <h1 className="text-6xl">Check out our Sneakers!</h1>
            <p className="mt-2 text-2xl font-normal">
              In search for a pair that won't let you down?
              <br />
              Well you've come to the right place.
            </p>
        </div>
      </div>
      <div className="layout-base my-12 min-h-0 dust">
        <Grid
          title={"Featured"}
